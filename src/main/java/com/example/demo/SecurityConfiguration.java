...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected RelyingPartyRegistrationRepository relyingPartyRegistrations() throws Exception {
		...
		File verificationKey = new File("d:\\projects\\okta.cert");
	    ...
	    RelyingPartyRegistration registration = RelyingPartyRegistration
	            ...
	            .assertingPartyDetails(party -> party
	                .entityId("http://www.okta.com/exk9o5guploxo6hK45d7")
	                .singleSignOnServiceLocation("https://dev-77409672.okta.com/app/dev-77409672_devbms_1/exk9o5guploxo6hK45d7/sso/saml")
