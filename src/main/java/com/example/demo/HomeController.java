...
public class HomeController {
	...
	public String secured(@AuthenticationPrincipal Saml2AuthenticatedPrincipal principal, Model model,HttpServletRequest httpServletRequest) {
		System.out.println(httpServletRequest.getParameter("stateToken"));
